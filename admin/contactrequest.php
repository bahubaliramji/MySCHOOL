...
<title>MySCHOOL || ContactRequest</title>
            ...
            <div class="sidebar-sticky">
                <ul class="nav flex-column">
                    ...
                    <li  class="nav-item active" style="background-color:#225470;">
                        <a style="color:white;"  href="contactrequest.php" class="nav-link" >
                            <!-- <i class="fas fa-accessible-icon"></i> -->
                            <!-- <i class="fab fa-accessible-icon"></i> -->
...
<div class="col-sm-9 mt-5">
    <!-- table -->
    <p class="bg-dark text-white p-2">List of Contact Requests</p>
    <?php
