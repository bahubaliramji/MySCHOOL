...
<title>MySCHOOL || EditStudent</title>
...
<div class="col-sm-6 mt-5 mx-3 jumbotron">
    ...
    <form id="updateForm"  method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="stu_email" name="stu_email" value="<?php if(isset($row['stu_email'])){ echo $row['stu_email']; }?>" required>
        </div>
        <div class="form-group">
        ...
        <div class="text-center">
            <button class="btn btn-danger" type="submit" id="requpdateStu" name="requpdateStu">Update</button>
